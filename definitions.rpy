...
#I was going 'Ooooh' in my head when going through these~!
#I'll let the friendly Mod team go over it for me.
#Not too confident yet ehehe~
...
#------------------------------------------------These are the character variables and persistent values. 
#------------------------------------------------Try not to mess with these so much, unless you know what you're doing!
# Character variables
